...
public interface UserDao {
	...
	/**
	 * @Description 根据用户ID，从数据库中获取用户实体数据
	 * @author 李浩然
	...
	/**
	 * @Description 根据用户Email，从数据库中获取用户实体数据
	 * @author 李浩然
	...
	/**
	 * @Description 根据班级ID，从数据库中获取班级中所有用户的实体数据
	 * @author 李浩然
	...
	/**
	 * @Description 更新数据库中指定用户的信息（不包括userId, email, password, headImage）
	 * @author 李浩然
