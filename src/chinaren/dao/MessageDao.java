...
public interface MessageDao {
	...
	/**
	 * @Description 根据留言ID，从数据库中获取留言数据
	 * @author 李浩然
	...
	/**
	 * @Description 从数据库中获取属于该班级的所有留言数据
	 * @author 李浩然
	...
	/**
	 * @Description 从数据库中获取一个用户发布的所有留言数据
	 * @author 李浩然
