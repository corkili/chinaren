...
public interface ClassDao {
	...
	/**
	 * @Description 根据班级ID，从数据库中获取班级实体数据
	 * @author 李浩然
	...
	/**
	 * @Description 根据班级信息，从数据库中获取班级实体数据（完全匹配）
	 * @author 李浩然
	 * @param province 省份
	 * @param city 城市
	 * @param area 地区
	...
	/**
	 * @Description 根据班级管理者的用户ID，从数据库中获取班级数据
	 * @author 李浩然
	 * @param managerId
	...
	/**
	 * @Description 根据班级信息，从数据库中获取班级实体数据（模糊查询）
	 * @author 李浩然
	 * @param province 省份
	 * @param city 城市
	 * @param area 地区
