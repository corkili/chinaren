...
public class UserServiceImpl implements UserService {
	...
	public Result<Boolean> register(ServletContext servletContext, User user, String code) {
		...
		if (!HeadImageUtil.createDefaultHeadImage(servletContext.getRealPath(HeadImageUtil.PATH_NAME), user.getUserId())) {
			return new Result<Boolean>(false, "创建头像时发生错误，请重试！", false);
		}
		user.setHeadImage(HeadImageUtil.BASE_NAME + user.getUserId() + HeadImageUtil.POSTFIX);
